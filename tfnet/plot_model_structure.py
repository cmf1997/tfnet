...
from tfnet.networks import DeepMHCII
...
model = DeepMHCII(conv_num = conv_num, conv_size = conv_size, conv_off = conv_off, linear_size = linear_size)

tf_name_seq = get_tf_name_seq('/lustre/home/acct-medzy/medzy-cai/project/project_tf_dl/DeepMHCII-multi-tf/data/pseudosequence.2016.all.X.dat')
